...
public class TrainingExercisesListAdapter extends ArrayAdapter<Exercise> {
    private ArrayList<Exercise> exerciseList;

    public TrainingExercisesListAdapter(@NonNull Context context, int resource, @NonNull ArrayList<Exercise> objects) {
